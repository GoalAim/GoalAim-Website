...
const PrivacyPolicy = () => {
    ...
    return (
        <Box sx={{display: "flex", flexDirection: "column", alignItems: "center", backgroundColor: theme.BackgroundColor, padding: "50px", paddingTop: "50px", color: theme.TextColor}}>
            <Box style={{alignSelf: "center", width: "80%", border: "solid", borderWidth: 1, borderColor: theme.BorderColor, borderRadius: 100, marginTop: "0px", marginBottom: "80px"}}></Box>
            <Box sx={{display: "flex", flexDirection: "column", marginLeft: "5vw", marginRight: "5vw", maxWidth: "1000px"}}>
                <Typography style={{fontSize: 30, fontWeight: "bold"}}>Privacy Policy</Typography>
                <Typography style={{fontSize: 20, fontStyle: "italic", marginBottom: "50px"}}>Last updated: April 05, 2025</Typography>
                <Typography style={PrivacyStyles.text}>
                ...
                <Typography style={PrivacyStyles.title}>Interpretation and Definitions</Typography>
                <Typography style={PrivacyStyles.subtitle}>Interpretation</Typography>
                <Typography style={PrivacyStyles.text}>
                    The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
                </Typography>
                <Typography style={PrivacyStyles.subtitle}>Definitions</Typography>
                <Typography style={PrivacyStyles.text}>
                    ...
                    <ul>
                        ...
                        <li><b>Application</b> refers to GoalAim, the software program provided by the Company.</li>
                        <li><b>Company</b> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to GoalAim.</li>
                        <li><b>Country</b> refers to: France</li>
                        ...
                        <li><b>Sevice</b> refers to the Application.</li>
                ...
                <Typography style={PrivacyStyles.title}>Collecting and Using Your Personal Data</Typography>
                <Typography style={PrivacyStyles.subtitle}>Types of Data Collected</Typography>
                <Typography style={PrivacyStyles.subsubtitle}>Personal Data</Typography>
                <Typography style={PrivacyStyles.text}>
                ...
                <Typography style={PrivacyStyles.subsubtitle}>Usage Data</Typography>
                <Typography style={PrivacyStyles.text}>
                ...
                <Typography style={PrivacyStyles.subtitle}>Use of Your Personal Data</Typography>
                <Typography style={PrivacyStyles.text}>
                ...
                <Typography style={PrivacyStyles.subtitle}>Retention of Your Personal Data</Typography>
                <Typography style={PrivacyStyles.text}>
                ...
                <Typography style={PrivacyStyles.subtitle}>Transfer of Your Personal Data</Typography>
                <Typography style={PrivacyStyles.text}>
                ...
                <Typography style={PrivacyStyles.subtitle}>Delete Your Personal Data</Typography>
                <Typography style={PrivacyStyles.text}>
                ...
                <Typography style={PrivacyStyles.subtitle}>Disclosure of Your Personal Data</Typography>
                <Typography style={PrivacyStyles.subsubtitle}>Business Transactions</Typography>
                <Typography style={PrivacyStyles.text}>
                    If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
                </Typography>
                <Typography style={PrivacyStyles.subsubtitle}>Law enforcement</Typography>
                <Typography style={PrivacyStyles.text}>
                    Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
                </Typography>
                <Typography style={PrivacyStyles.subsubtitle}>Other legal requirements</Typography>
                <Typography style={PrivacyStyles.text}>
                ...
                <Typography style={PrivacyStyles.subtitle}>Security of Your Personal Data</Typography>
                <Typography style={PrivacyStyles.text}>
                    The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.
                </Typography>
                <Typography style={PrivacyStyles.title}>Children's Privacy</Typography>
                <Typography style={PrivacyStyles.text}>
                ...
                <Typography style={PrivacyStyles.title}>Links to Other Websites</Typography>
                <Typography style={PrivacyStyles.text}>
                ...
                <Typography style={PrivacyStyles.title}>Changes to this Privacy Policy</Typography>
                <Typography style={PrivacyStyles.text}>
                ...
                <Typography style={PrivacyStyles.title}>Contact Us</Typography>
                <Typography style={PrivacyStyles.text}>
                    If you have any questions about this Privacy Policy, You can contact us:<br />
                    <ul>
                        <li>By email: <a href="mailto:contact.goalaim@gmail.com" style={{textDecoration: "none", color: theme.TextColor, fontWeight: "bold"}}>contact.goalaim@gmail.com</a></li>
                        <li>By visiting this page on our website: <a href="https://goalaim-app.com/support" style={{textDecoration: "none", color: theme.TextColor, fontWeight: "bold"}}>https://goalaim-app.com/support</a></li>
                    </ul>
                </Typography>
            </Box>
        </Box>
